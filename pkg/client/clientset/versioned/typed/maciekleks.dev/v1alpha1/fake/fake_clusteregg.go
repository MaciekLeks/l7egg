...
var clustereggsKind = schema.GroupVersionKind{Group: "maciekleks.dev", Version: "v1alpha1", Kind: "ClusterEgg"}
...
func (c *FakeClusterEggs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterEggList, err error) {
	...
	list := &v1alpha1.ClusterEggList{ListMeta: obj.(*v1alpha1.ClusterEggList).ListMeta}
	for _, item := range obj.(*v1alpha1.ClusterEggList).Items {
